...
<html lang="en">
<head>
<title>HR web servises a Corporate Business Category Flat Bootstrap Responsive Website | Web Icons :: w3layouts</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			<div class="agile_header_grid">
				<div class="w3_agile_logo">
					<h1><a href="index.html"><span>HR</span>web servises</a></h1>
				</div>
				<div class="agileits_w3layouts_sign_in">
					<ul>
						<li><a href="#small-dialog" class="play-icon popup-with-zoom-anim">Sign In</a></li>
						<li>Call us : <span>(+91)9169285858</span></li>
					</ul>
				</div>
		...
		<div class="w3layouts_newsletter">
			<div class="container">
				...
				<div class="w3layouts_newsletter_right">
					<form action="#" method="post">
						<input type="text-area" name="comment" placeholder="comment..." required="">
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					<h2><a href="index.html"><span>HR</span> web servises</a></h2>
					<p>Aliquam lacus tur <a href="#">http://hrwebservises.com</a></p>
				</div>
				<div class="col-md-3 w3_footer_grid">
					...
					<h4>Address</h4>
					<p>Pandharpur Dst solapur (Maharashtra)India 413315.</p>
				</div>
				...
				<div class="col-md-3 w3_footer_grid">
					...
					<h4>Mail Us</h4>
					<p><a href="mailto:hrwebservises11@.com">hrwebservises11@.com</a>
						</p>
				</div>
				<div class="clearfix"> </div>
			</div>
	...
	<div class="copyright">
		<div class="container">
			<div class="w3ls_copyright_left">
				...
				<p>© 2020 HR web servises./ Design by HR web servises</p>
			</div>
